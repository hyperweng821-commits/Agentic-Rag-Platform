...
from app.api.dependencies import KnowledgeService
...
async def list_knowledge_bases(
    ...
    items = await service.list_knowledge_bases(limit=limit, offset=offset)
...
async def retry_ingestion_job(
    ...
    return IngestionJobResponse.model_validate(await service.retry_ingestion_job(job_id))
